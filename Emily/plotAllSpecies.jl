...
#         BoxPlotAvg=plot(title=species*"avg ss\n")
                thisPlotStd=plot(title=species)
...
#             println(stdOfCondition)
            plot!(thisPlotStd,meanOfCondition',grid=false,color=lineColor,ribbon=stdOfCondition',fillalpha=0.05,label=condition,linewidth=5)
